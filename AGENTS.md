...
- 需求口径：关键词「绿植租摆 + 办公绿化系（办公绿化/办公区绿化/办公室绿化/办公场所绿化）+ 职场绿植绿化」× 8 城（南京/上海/苏州/杭州/武汉/深圳/广州/合肥）× 发布时间 2026-07-01 ~ 2026-08-31；词库收窄必须 config.active 与 DB keyword_state 两层同步。
